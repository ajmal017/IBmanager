...
from market_data import create_contract as create_contract
import sys
...
class TestClient(EClient):
    ...
    def get_IB_historical_data(self, ibcontract,enddate, durationStr="1 Y", barSizeSetting="1 day",
...
data = get_data('SPY','STK','SMART','USD',duration ="60 Y",enddate = today,barsize='1 month')
